...
export const registerBattle: RegisterBattle =
  (battleRepository, local) => async (firstPlayerName, secondPlayerName, stepBase, unitCount, version) => {
...
export const startBattle: StartBattle = (battleRepository, local) => async (battle, units) => {
