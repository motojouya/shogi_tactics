...
// #2 足止め(tutorial.md)。後手桂(3,3)が先手角の隣へ直進しようとして、足止めを持つ先手金(2,5)で止められる。
const ASHIDOME_CELLS: DiagramCell[] = [
  ...
  { col: 3, row: 3, piece: 'knight', side: 'SECOND' },
  { col: 5, row: 3, piece: 'lance', side: 'SECOND' },
...
const ASHIDOME_ARROWS: DiagramArrow[] = [{ from: [3, 3], to: [2, 4.35] }];
// 足止めする先手金のマスを強調する。
const ASHIDOME_HIGHLIGHTS: DiagramHighlight[] = [{ cols: [2, 2], rows: [5, 5], color: '#d32f2f' }];
